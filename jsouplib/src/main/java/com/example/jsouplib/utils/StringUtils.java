package com.example.jsouplib.utils;
...
public class StringUtils {
    ...
    public static boolean isAnyEmpty(final CharSequence... css) {
        if (com.blankj.utilcode.util.ArrayUtils.isEmpty(css)) {
            return true;
        }
    ...
    public static int indexOfAny(final CharSequence cs, final char... searchChars) {
        if (isEmpty(cs) || com.blankj.utilcode.util.ArrayUtils.isEmpty(searchChars)) {
            return INDEX_NOT_FOUND;
        }
    ...
    public static boolean containsAny(CharSequence cs, CharSequence... searchCharSequences) {
        if (isEmpty(cs) || com.blankj.utilcode.util.ArrayUtils.isEmpty(searchCharSequences)) {
            return false;
        }
    ...
    public static String reverseDelimited(final String str, final char separatorChar) {
        ...
        com.blankj.utilcode.util.ArrayUtils.reverse(strs);
    ...
    public static boolean startsWithAny(final CharSequence string, final CharSequence... searchStrings) {
        if (isEmpty(string) || com.blankj.utilcode.util.ArrayUtils.isEmpty(searchStrings)) {
            return false;
        }
    ...
    public static String getDuration(String duration) {
        try {
            if(StringUtils.isNotEmpty(duration)){
                ...
                String result = String.format(time,Long.valueOf(duration)/3600, (Long.valueOf(duration)-(Long.valueOf(duration)/3600)*3600)/60,Long.valueOf(duration)%60);
